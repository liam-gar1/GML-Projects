...
file=file_text_open_read(working_directory+"/Datafiles/match_quantity.txt");
...
file=file_text_open_read(working_directory+"/Datafiles/file_names.txt");
...
draw_sprite(sprite_add(working_directory+"/Datafiles/Database/"+line,0,0,0,0,0),0,205,185);

file=file_text_open_read(working_directory+"/Datafiles/display_names.txt");
for(i=0;i<=global.database_index;i++){
	line=file_text_read_string(file); //Column Titles
	if(i==0 and line=="Escherichia Coli"){
		file1 = file_text_open_write(working_directory+"/Datafiles/bacterial.txt");
...
file=file_text_open_read(working_directory+"/Datafiles/confidence.txt");
for(i=0;i<=global.database_index;i++){
	line=file_text_read_string(file); //Column Titles
	file_text_readln(file);
}
...
file=file_text_open_read(working_directory+"/Datafiles/bacterial.txt");
line=file_text_read_string(file); //Column Titles
file_text_close(file);
