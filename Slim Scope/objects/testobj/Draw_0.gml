...
if(global.index=1){
	file=file_text_open_read(working_directory+"/display_image_name.txt");
	...
	draw_sprite(sprite_add("C:/Users/user/Desktop/Random/Apps/Slim Scope/Resized Captures/"+line,0,0,0,0,0),0,735,210);
}
if(global.index=2){
